...
const Navbar = () => {
    ...
    return (
        <>
            {isSmallScreen
                ?
                <div ref={dropdownRef} className="font-raleway">
                    <div className="z-20 fixed top-0 bottom-auto left-0 right-0 h-14 border-2 border-primary bg-bg-primary">
                        <div className=""></div>
                    ...
                    <Transition
                        ...
                        className={'fixed w-full bg-bg-primary'}
                    >
                        <div className="flex">
